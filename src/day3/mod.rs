...
use self::sack_content::SackContent;
use crate::{
...
pub type Day3Input = Vec<SackContent>;

impl SolutionInput for Day3Input {
...
mod tests {
    ...
    lazy_static! {
        static ref INPUT_TEST: Day3Input = get_input::<Day3Pt1>("test.txt").unwrap();
        static ref INPUT_MAIN: Day3Input = get_input::<Day3Pt1>("input.txt").unwrap();
    }
